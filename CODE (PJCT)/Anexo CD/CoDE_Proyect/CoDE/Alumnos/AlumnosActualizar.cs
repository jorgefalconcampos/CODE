...
{
    public partial class AlumnosActualizar : Form, DPFP.Capture.EventHandler
    {
        public AlumnosActualizar()
        { InitializeComponent(); cp.EventHandler = this; }

        private void AlumnosActualizar_Load(object sender, EventArgs e)
        ...
        {
            txtNumBoleta.Text = ""; txtNombre.Text = ""; txtApP.Text = "";
            txtApM.Text = ""; cboTurno.SelectedIndex = -1; cboCarrera.SelectedIndex = -1;
            cboGrupo.SelectedIndex = -1; txtNombreTutor.Text = ""; txtEmailTutor.Text = "";
            ImgAlumno.Image = null; ImgAlumno.BackgroundImage = Properties.Resources.AñadirAlumno; lblMensajeFoto.Text = "";
        }
        ...
        {
            try
            { string AA = "Buen día, esta ventana le ayudará a actualizar los datos del alumno..."
                      + "Modifique los datos pertinentes, haga clic en actualizar alumno y después en finalizar actualización..."
        ...
        {
            ImgAlumno.Image = ImgRecibir; lblMensajeFoto.Visible = true;
        ...
        {
            if (ImgAlumno.Image == null) { MessageBox.Show("Para borrar un archivo primero debe subir uno.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); }
            else
            {
        ...
        private void bntActualizarAlumno_Click(object sender, EventArgs e)
        {
            if (Errores())
            { MessageBox.Show("Error en los datos, el alumno no pudo ser registrado.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); }
            else
            {
                try
                {
                    ...
                    ActualizarAlumno(txtNumBoleta.Text, txtNombre.Text, txtApP.Text, txtApM.Text, FotoBytes, Convert.ToString(cboTurno.SelectedItem), 
                ...
                catch
                {
                    ...
                    ErrorActualizar = MessageBox.Show("Error al actualizar alumno. Si necesita ayuda, puede visitar nuestro Manual de Ayudas con información que puede ayudarle. " 
        ...
        private void ActualizarAlumno(string Boleta, string Nombre, string AP, string AM, byte[] Imagen, string Turno, string Carrera, string Grupo, string NombreTutor, string EmailTutor)
        { Procesos.ActualizarAlumno(Boleta, Nombre, AP, AM, Imagen, Turno, Carrera, Grupo, NombreTutor, EmailTutor); }
        ...
        private void btnEscanearHuella_Click(object sender, EventArgs e)
        {
            if ((ValorLector == "Conectado"))
            {
                cp.StopCapture(); MessageBox.Show("El escaneo se está iniciando...",
            ...
            { MessageBox.Show("No se inició el escaneo porque el lector está desconectado.",
        ...
        private void AlumnosActualizar_FormClosed(object sender, FormClosedEventArgs e)
        { cp.StopCapture(); }
        ...
        private void btnTerminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                { MessageBox.Show("No se pudo finalizar la actualización del alumno. Razón: No existe huella.",
                    "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); BarraProgreso.Value = 0;
                }
                else
                {
                    BarraProgreso.Value = 0; DialogResult Finalizado;
                    Finalizado = MessageBox.Show("La actualización de " + txtNumBoleta.Text +
        ...
        private void EditarGrupoDatos_Click(object sender, EventArgs e)
        {
            ...
            txtApP.Enabled = !txtApP.Enabled;
            txtApM.Enabled = !txtApM.Enabled;
            txtNombreTutor.Enabled = !txtNombreTutor.Enabled;
            txtEmailTutor.Enabled = !txtEmailTutor.Enabled;
        }

        private void EditarGrupoImagen_Click(object sender, EventArgs e)
        {
            btnTomarFoto.Enabled = !btnTomarFoto.Enabled;
            btnSubirFoto.Enabled = !btnSubirFoto.Enabled;
        ...
        private void AlumnosActualizar_FormClosing(object sender, FormClosingEventArgs e)
        { if (Procesos.CerrarSesionPress) { Procesos.CerrarSesion(e); }}

        private void AlumnosActualizar_MouseMove(object sender, MouseEventArgs e)
